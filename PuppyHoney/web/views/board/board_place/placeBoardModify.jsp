        ...
        <div>
            <div class="form-group">
                    ...
                    <select name="location" class="custom-select">
                    	<%if(pb.getPlBoardArea().equals("서울")){ %>
                       	   <option id="location" value="서울" selected>서울</option>
                           ...
                           <%}else if(pb.getPlBoardArea().equals("경기")) {%>
                           <option id="location" value="서울" >서울</option>
                           <option id="location" value="경기도" selected>경기도</option>
                           <option id="location" value="강원도" >강원도</option>
                           <option id="location" value="경상도" >경상도</option>
                           <option id="location" value="전라도" >전라도</option>
                           <option id="location" value="충청도" >충청도</option>
                           <option id="location" value="제주도" >제주도</option>
                           <%}else if(pb.getPlBoardArea().equals("강원")) {%>
                           <option id="location" value="서울" >서울</option>
                           <option id="location" value="경기도" >경기도</option>
                           <option id="location" value="강원도" selected>강원도</option>
                           <option id="location" value="경상도" >경상도</option>
                           <option id="location" value="전라도" >전라도</option>
                           <option id="location" value="충청도" >충청도</option>
                           <option id="location" value="제주도" >제주도</option>
                           <%}else if(pb.getPlBoardArea().equals("경상")) {%>
                           <option id="location" value="서울" >서울</option>
                           <option id="location" value="경기도" >경기도</option>
                           <option id="location" value="강원도" >강원도</option>
                           <option id="location" value="경상도" selected>경상도</option>
                           <option id="location" value="전라도" >전라도</option>
                           <option id="location" value="충청도" >충청도</option>
                           <option id="location" value="제주도" >제주도</option>
                           <%}else if(pb.getPlBoardArea().equals("전라")) {%>
                           <option id="location" value="서울" >서울</option>
                           <option id="location" value="경기도" >경기도</option>
                           <option id="location" value="강원도" >강원도</option>
                           <option id="location" value="경상도" >경상도</option>
                           <option id="location" value="전라도" selected>전라도</option>
                           <option id="location" value="충청도" >충청도</option>
                           <option id="location" value="제주도" >제주도</option>
                           <%}else if(pb.getPlBoardArea().equals("충청")) {%>
                            <option id="location" value="서울" >서울</option>
                           <option id="location" value="경기도" >경기도</option>
                           <option id="location" value="강원도" >강원도</option>
                           <option id="location" value="경상도" >경상도</option>
                           <option id="location" value="전라도" >전라도</option>
                           <option id="location" value="충청도" selected>충청도</option>
                           <option id="location" value="제주도" >제주도</option>
                           <%}else {%>
                            <option id="location" value="서울" >서울</option>
                           <option id="location" value="경기도" >경기도</option>
                           ...
                           <option id="location" value="전라도" >전라도</option>
                           <option id="location" value="충청도" >충청도</option>
                           <option id="location" value="제주도" selected>제주도</option>
                           <%} %>
                    </select>
            </div>
        </div>
        ...
        <div>
           <label for="phone">연락처</label> 
            <div class="form-group row pl-3"> 
                <input type="text" class="form-control col-md-2" name ="phone1" id="phone1" pattern="[0-9]{2,3}" title="지역번호 및 숫자만입력해주세요." placeholder="지역번호"  value='<%=placeBoardNum1%>' required> -   
                <input type="text" class="form-control col-md-3" name ="phone2" id="phone2" pattern="[0-9]{3,4}" title="최소 3자리  최대 4자리까지 숫자만입력해주세요." placeholder="xxxx" value='<%=placeBoardNum2%>' required> -
                <input type="text" class="form-control col-md-3" name ="phone3" id="phone3" pattern="[0-9]{3,4}" title="최소 3자리  최대 4자리까지 숫자만입력해주세요." placeholder="xxxx" value='<%=placeBoardNum3%>' required> 
            </div> 
        </div>  
