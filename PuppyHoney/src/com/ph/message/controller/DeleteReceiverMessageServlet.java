...
/**
 * Servlet implementation class DeleteReceiverMessageServlet
 */
@WebServlet("/message/deleteReceiveMessage")
public class DeleteReceiverMessageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DeleteReceiverMessageServlet() {
        super();
