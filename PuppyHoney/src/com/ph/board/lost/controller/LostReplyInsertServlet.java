...
/**
 * Servlet implementation class LostReplyInsertServlet
 */
@WebServlet("/Reply/lostReplyInsert")
public class LostReplyInsertServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LostReplyInsertServlet() {
        super();
