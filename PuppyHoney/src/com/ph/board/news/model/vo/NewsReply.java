...
public class NewsReply {
   ...
   public NewsReply(int replyNum, int boardRef, String replyId, String replyDate, String replyContent, int replyGood,
   ...
   public String toString() {
      return "NewsReply [replyNum=" + replyNum + ", boardRef=" + boardRef + ", replyId=" + replyId + ", replyDate="
